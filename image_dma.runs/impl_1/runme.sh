...
HD_PWD='D:/Kishore_Sir_Project/image_dma/image_dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source image_test_wrapper.tcl -notrace
