...
HD_PWD='D:/Kishore_Sir_Project/image_dma/image_dma.runs/image_test_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_test_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_test_processing_system7_0_0.tcl
